<template>
  <div>
    <h2>监视reactive的对象的属性，与监视ref的对象的属性相同</h2>
...
<script setup lang="ts" name="WatchReactiveAttr">
...
// 如果需要监听响应式对象内的对象的基本数据类型属性，需要使用getter函数返回属性值
// getter函数即是一个返回属性值的函数
watch(() => user.name, (newValue, oldValue) => {
  console.log('name变化了', newValue, oldValue)
})

// 如果需要监听响应式对象内的对象的对象类型属性，可以直接监视该对象
// 强制深度监视，且不能关闭深度监视
